        ...
        if #available(macOS 11.0, *) {
            ...
            if let settings = settings {
                if let orientationValue = settings.orientation,
                   let orientation = NSPrintInfo.PaperOrientation(rawValue: orientationValue) {
                ...
                if let horizontalPagination = settings.horizontalPagination,
                   let pagination = NSPrintInfo.PaginationMode(rawValue: horizontalPagination) {
                    printInfo.horizontalPagination = pagination
                }
                if let verticalPagination = settings.verticalPagination,
                   let pagination = NSPrintInfo.PaginationMode(rawValue: verticalPagination) {
            ...
            if let settings = settings {
                if let pageOrder = settings.pageOrder, let order = NSPrintOperation.PageOrder(rawValue: pageOrder) {
